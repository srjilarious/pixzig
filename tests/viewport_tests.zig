...
pub fn viewportStretchFillsFramebufferTest(io: std.Io, alloc: std.mem.Allocator) !void {
    ...
    try testz.expectEqual(@as(i32, 0), vp.viewportPx.l);
    try testz.expectEqual(@as(i32, 0), vp.viewportPx.t);
    try testz.expectEqual(@as(i32, 800), vp.viewportPx.r);
    try testz.expectEqual(@as(i32, 600), vp.viewportPx.b);
...
pub fn viewportStretchScalesIndependentlyTest(io: std.Io, alloc: std.mem.Allocator) !void {
    ...
    try testz.expectEqual(@as(i32, 0), vp.viewportPx.l);
    try testz.expectEqual(@as(i32, 0), vp.viewportPx.t);
    try testz.expectEqual(@as(i32, 1920), vp.viewportPx.r);
    try testz.expectEqual(@as(i32, 1080), vp.viewportPx.b);
...
pub fn viewportFitPillarboxTest(io: std.Io, alloc: std.mem.Allocator) !void {
    ...
    try testz.expectEqual(@as(i32, 240), vp.viewportPx.l);
    try testz.expectEqual(@as(i32, 0), vp.viewportPx.t);
    try testz.expectEqual(@as(i32, 1680), vp.viewportPx.r);
    try testz.expectEqual(@as(i32, 1080), vp.viewportPx.b);
}
...
pub fn viewportFitLetterboxTest(io: std.Io, alloc: std.mem.Allocator) !void {
    ...
    try testz.expectEqual(@as(i32, 0), vp.viewportPx.l);
    try testz.expectEqual(@as(i32, 96), vp.viewportPx.t);
    try testz.expectEqual(@as(i32, 1024), vp.viewportPx.r);
    try testz.expectEqual(@as(i32, 672), vp.viewportPx.b);
}
...
pub fn viewportIntegerFitLetterboxTest(io: std.Io, alloc: std.mem.Allocator) !void {
    ...
    try testz.expectEqual(@as(i32, 320), vp.viewportPx.l);
    try testz.expectEqual(@as(i32, 60), vp.viewportPx.t);
    try testz.expectEqual(@as(i32, 1600), vp.viewportPx.r);
    try testz.expectEqual(@as(i32, 1020), vp.viewportPx.b);
}
...
pub fn viewportIntegerFit1600x900Test(io: std.Io, alloc: std.mem.Allocator) !void {
    ...
    try testz.expectEqual(@as(i32, 0), vp.viewportPx.t);
    try testz.expectEqual(@as(i32, 1600), vp.viewportPx.r);
    try testz.expectEqual(@as(i32, 900), vp.viewportPx.b);
}
...
pub fn viewportFramebufferToLogicalValidTest(io: std.Io, alloc: std.mem.Allocator) !void {
    _ = io;
    _ = alloc;
    // fit: 320x240 in 1920x1080 -> scale=4.5, viewportPx=(240,0,1680,1080)
...
pub fn viewportLogicalToFramebufferIntegerFitTest(io: std.Io, alloc: std.mem.Allocator) !void {
    _ = io;
    _ = alloc;
    // integer_fit: 320x240 in 1920x1080, scale=4, viewportPx=(320,60,...)
...
pub fn viewportUpdateFramebufferSizeLetterboxTest(io: std.Io, alloc: std.mem.Allocator) !void {
    ...
    try testz.expectEqual(@as(i32, 32), vp.viewportPx.l);
    try testz.expectEqual(@as(i32, 114), vp.viewportPx.t);
}
...
pub fn viewportFixedScaleTest(io: std.Io, alloc: std.mem.Allocator) !void {
    ...
    try testz.expectTrue(approxEq(vp.scale.x, 3.0));
    try testz.expectEqual(@as(i32, 480), vp.viewportPx.l);
    try testz.expectEqual(@as(i32, 270), vp.viewportPx.t);
    try testz.expectEqual(@as(i32, 1440), vp.viewportPx.r);
    try testz.expectEqual(@as(i32, 810), vp.viewportPx.b);
}
...
pub fn viewportWindowToLogicalLetterboxNullInBarTest(io: std.Io, alloc: std.mem.Allocator) !void {
    _ = io;
    _ = alloc;
    // fit: 320x180 logical in 1024x768 fb -> scale=3.2, viewportPx=(0,96,1024,672)
...
pub fn viewportWindowToLogicalLetterboxCenterTest(io: std.Io, alloc: std.mem.Allocator) !void {
    _ = io;
    _ = alloc;
    // fit: 320x180 in 1024x768, scale=3.2, viewportPx=(0,96,1024,672)
...
pub fn viewportWindowToLogicalPillarboxNullInBarTest(io: std.Io, alloc: std.mem.Allocator) !void {
    _ = io;
    _ = alloc;
    // fit: 320x240 logical in 1920x1080 fb -> scale=4.5, viewportPx=(240,0,1680,1080)
