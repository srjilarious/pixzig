...
pub fn basicMoveRightWithWallGoalTest() !void {
    ...
    try ts.tiles.append(Tile{ .core = pixzig.tile.Clear, .properties = null, .alloc = alloc });
    try ts.tiles.append(Tile{ .core = pixzig.tile.BlocksAll, .properties = null, .alloc = alloc });
    tl.tileset = &ts;
